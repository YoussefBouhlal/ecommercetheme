...
<main class="main-site" role="main">
    ...
    <div class="single-product mt-24 mb-24">
        <div class="container">
            <div class="single-product__content">
                ...
                <div class="single-product__images">
                    ...
                    <div class="single-product__images__thumbs">
                        <div class="single-product__images__thumbs--carousel">
                            <div class="single-product__images__thumbs__content">
                ...
                <div class="single-product__info">
                    ...
                    <div class="single-product__footer bg-white">

                        <div class="single-product__quantity">
                            <button class="single-product__quantity__minus">-</button>
                            <input class="single-product__quantity__input" type="text" value="1" readonly>
                            <button class="single-product__quantity__plus">+</button>
                        </div>

                        <div class="single-product__add-to-cart">
                            <button class="single-product__add-to-cart__btn bg-yellow"><p class="text-uppercase text-bold text-black">add to cart</p></button>
                        </div>

                        <div class="single-product__heart">
                            <button class="single-product__heart__btn bg-white">
                                <div class="single-product__heart__image">
                                    <?php svg('heart'); ?>
                                </div>
                            </button>
                        </div>
